...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/05/29 12:46:46 by atlekbai          #+#    #+#             */
/*   Updated: 2018/05/29 12:46:46 by atlekbai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "commands.h"

static void		xor2(t_byte *acg_split, t_byte **map, t_proc **procs, int64_t i)
{
	int64_t			args[3];
