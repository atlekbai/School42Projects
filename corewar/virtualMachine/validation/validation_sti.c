...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/05/29 13:25:58 by atlekbai          #+#    #+#             */
/*   Updated: 2018/05/29 13:25:59 by atlekbai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				validation_sti(t_byte *acg, t_proc **procs, t_byte **map)
{
	int i;
