...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/05/29 13:25:38 by atlekbai          #+#    #+#             */
/*   Updated: 2018/05/29 13:25:39 by atlekbai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				validation_ldi(t_byte *acg, t_proc **procs, t_byte **map)
{
	int i;
